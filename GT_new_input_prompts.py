...
image_folder = '/sample_4/images_all_4'
GT_folder = '/GT_prompts/sample_4/GT'
...
for filename in os.listdir(image_folder):
    if filename.endswith('.tif'):  # Assuming your images have a .tif extension
        ...
        # Find the corresponding GT image with the same number
        gt_filename = f"set1sample6raw_{image_number}.png"
        ...
        if os.path.exists(gt_path):
            ...
            def get_white_pixel_coordinates(image_array):
                width, height = image_array.shape[::-1]  # Get the width and height from the NumPy array shape
                coordinates = []
            ...
            def main():
                ...
                white_pixel_coordinates = get_white_pixel_coordinates(im)
                print("Number of white pixels with value 255:", len(white_pixel_coordinates))
        ...
        folder_path = "/sample_5/pred_masks_np_arrays_4" #"There is no need to save it, I did as I wanted to trace everything"
        csv_folder = "/SAM/sample_5"
        ...
        output_folder = '/sample_5/pred_final/cluster_1'
...
csv_filename = os.path.join(csv_folder, 'sample_6_cluster_1.csv')
